        ...
        ZStack {
            ...
            Canvas { ctx, size in
                ...
                let ringStyles: [(Double, Double)] = [
                    (Ring.outer,   0.55), // outermost — brightest
                    (Ring.zodiac,  0.45),
                    (Ring.houses,  0.35),
                    (Ring.planets, 0.25),
                ]
                ...
                for i in 0..<72 {
                    ...
                    // Major ticks: neon cyan; minor ticks: dim
                    ctx.stroke(path,
                               with: .color(major
                ...
                for (i, lon) in cuspLons.enumerated() {
                    ...
                    // Major axes (ASC/IC/DSC/MC): neon cyan; minor cusps: dim brand cyan
                    ctx.stroke(path,
                               with: .color(major
                ...
                for (key, planet) in sortedPlanets {
                    ...
                    // Retrograde ℞: offset inward — neon magenta
